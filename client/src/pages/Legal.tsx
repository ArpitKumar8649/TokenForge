...
const legalContent: Record<LegalVariant, { label: string; title: string; subtitle: string; sections: Array<{ heading: string; body: string }> }> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Discord membership verification", body: "To control dashboard access, TokenForge may use Discord OAuth with the identify scope and a server-side guild-membership check. The Discord account identifier and OAuth token are used transiently for that check and are not retained. TokenForge stores only the successful verification timestamp on the TokenForge account." },
