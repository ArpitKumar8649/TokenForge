  ...
  return (
    <div className="pricing-page">
      ...
      <main className="pricing-main">
        ...
        <section className="pricing-heading"><div className="demo-kicker"><span /> Transparent beta access</div><h1>Start with room<br />to <em>make something real.</em></h1><p>TokenForge is currently a controlled free beta. The available plan reflects the published request, token, and concurrency safeguards—no checkout or payment collection is enabled.</p></section>
