...
import { ArrowRight, CheckCircle2, ExternalLink, Loader2, LockKeyhole, MessageCircle, ShieldCheck, TriangleAlert } from "lucide-react";
...
export default function DiscordVerify({ embedded = false }: { embedded?: boolean }) {
  ...
  const inviteUrl = verification.data?.discordInviteUrl ?? "https://discord.gg/pnsWamDbe";
