    ...
    <div className="public-page tf-public-surface docs-page">
      ...
      <main className="docs-shell">
        <aside className="docs-sidebar">
          <p>Get started</p>
          <a href="#overview">Overview</a><a href="#authentication">Authentication</a><a href="#completions">Chat completions</a><a href="#claude-code">Claude Code</a><a href="#models">Models</a><a href="#limits">Beta limits</a><a href="#errors">Errors & limits</a>
