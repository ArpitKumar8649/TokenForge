...
const CLUSTER_MESSAGES_MODEL_IDS = new Set([
  ...
  "kimi-k3", "gemini-2.5-flash", "gemini-2.5-flash-lite", "mistral-large-3", "mistral-small-4", "minimax-m2", "minimax-m2-7", "qwen3.7-max", "claude-opus-5", "qwen3.8-27b", "qwen3.8-max",
]);
