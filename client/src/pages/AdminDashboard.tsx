...
export default function AdminDashboard() {
  ...
  const [section, setSection] = useState<"overview" | "accounts" | "controls" | "providers" | "operations" | "announcement" | "activity">("overview");
