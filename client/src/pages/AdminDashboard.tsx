...
import { Activity, AlertTriangle, ChartNoAxesCombined, Download, KeyRound, Loader2, LogOut, Power, Search, ServerCog, ShieldAlert, Trash2, UsersRound, WalletCards } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const [section, setSection] = useState<"overview" | "accounts" | "controls" | "activity">("overview");
