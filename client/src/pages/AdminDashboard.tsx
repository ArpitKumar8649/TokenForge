...
function OperationalControls() {
  ...
  const runGiveaway = trpc.admin.giveDiscordVerifiedAccountsCredit.useMutation({
    onSuccess: async result => {
      ...
      await Promise.all([utils.admin.discordVerifiedGiveawayRecipients.invalidate(), utils.admin.accounts.invalidate(), utils.admin.overview.invalidate(), utils.admin.activity.invalidate()]);
