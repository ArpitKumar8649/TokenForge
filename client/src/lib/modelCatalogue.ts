...
export const TOKENFORGE_MODELS: CatalogueModel[] = [
  ...
  model("glm-5", "GLM-5", "Z.AI", "GLM", "lime", 1, 3.2, "Z.AI reasoning", "A balanced Z.AI route for text reasoning, code, and streamed completions.", ["Reasoning", "Streaming", "Coding"], "Z.AI model pricing", "https://docs.z.ai/guides/overview/pricing"),
  ...
  model("minimax-m2-5", "MiniMax M2.5", "MiniMax", "M", "amber", 0.3, 1.2, "MiniMax production", "MiniMax’s M2.5 text model for streamed chat and coding completions.", ["Reasoning", "Streaming", "Coding"], "MiniMax API pay-as-you-go pricing", "https://platform.minimax.io/docs/guides/pricing-paygo"),
