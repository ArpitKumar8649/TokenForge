...
export const TOKENFORGE_MODELS: CatalogueModel[] = [
  ...
  model("claude-opus-5", "Claude Opus 5", "Configured upstream", "TF", "violet", 5, 25, "Custom configured route", "A configured custom upstream route for capable text reasoning, coding, and streamed chat completions. TokenForge does not assert provider identity or unsupported technical details beyond the configured route.", ["Reasoning", "Streaming", "Coding"], "TokenForge provisional configured-route pricing", "https://ai.kscsnkli.site"),
