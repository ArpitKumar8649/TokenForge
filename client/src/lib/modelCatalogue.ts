...
export const TOKENFORGE_MODELS: CatalogueModel[] = [
  ...
  model("deepseek-v4-flash", "DeepSeek V4 Flash", "DeepSeek", "DS", "sky", 0, 0, "TokenHarbor free route", "A fast DeepSeek text-chat route served through TokenHarbor’s `deepseek-v4-flash:free` endpoint.", ["Streaming", "Coding"], "TokenHarbor DeepSeek V4 Flash route", "https://tokenharbor.ai/docs"),
  model("deepseek-v4-pro", "DeepSeek V4 Pro", "DeepSeek", "DS", "sky", 0, 0, "Shared TokenHarbor route", "A compatibility route currently backed by the same TokenHarbor `deepseek-v4-flash:free` endpoint as DeepSeek V4 Flash.", ["Streaming", "Coding"], "TokenHarbor DeepSeek V4 Flash route", "https://tokenharbor.ai/docs"),
