...
export const TOKENFORGE_MODELS: CatalogueModel[] = [
  model("glm-5.3", "GLM 5.3", "Z.AI", "GLM", "lime", 1.4, 4.4, "Advanced Z.AI reasoning", "A configurable Z.AI route for advanced text reasoning, coding, and streamed chat workloads.", ["Reasoning", "Streaming", "Coding"], "TokenForge provisional GLM 5.3 configured-route pricing", "https://tokengate-cqt9ivzs.manus.space/pricing"),
  ...
  model("deepseek-v4-flash", "DeepSeek V4 Flash", "DeepSeek", "DS", "sky", 0.14, 0.28, "Fast text chat", "A fast text-chat option for everyday questions, writing, and coding tasks.", ["Streaming", "Coding"], "DeepSeek V4 Flash API pricing", "https://api-docs.deepseek.com/quick_start/pricing"),
  model("deepseek-v4-pro", "DeepSeek V4 Pro", "DeepSeek", "DS", "sky", 0.14, 0.28, "General text reasoning", "A capable text-chat option for analysis, writing, coding, and structured answers.", ["Streaming", "Coding"], "TokenForge model pricing", "https://tokengate-cqt9ivzs.manus.space/pricing"),
  model("claude-opus-5", "Claude Opus 5", "Claude", "AI", "violet", 5, 25, "Advanced reasoning", "A high-capability text model for detailed reasoning, coding, and streamed chat completions.", ["Reasoning", "Streaming", "Coding"], "TokenForge model pricing", "https://tokengate-cqt9ivzs.manus.space/pricing"),
  model("qwen3.8-27b", "Qwen3.8 27B", "Alibaba Cloud", "Q", "lime", 0.45, 3.2, "Qwen reasoning", "A capable 27B text model for reasoning, coding, and chat completions.", ["Reasoning", "Streaming", "Coding"], "Qwen3.8 27B API pricing", "https://openrouter.ai/qwen/qwen3.8-27b"),
  model("qwen3.8-max", "Qwen 3.8 Max", "Qwen", "Q", "lime", 2, 6, "Flagship Qwen reasoning", "A flagship Qwen route for advanced reasoning, coding, streamed chat, and inspectable Playground thinking summaries.", ["Reasoning", "Thinking", "Streaming", "Coding"], "OpenRouter Qwen3.8 Max published rate", "https://openrouter.ai/qwen/qwen3.8-max"),
  model("claude-fable-5", "Claude Fable 5", "Claude", "AI", "violet", 10, 50, "Advanced reasoning", "A capable text model for reasoning, coding, streamed chat, and inspectable Playground thinking summaries.", ["Reasoning", "Thinking", "Streaming", "Coding"], "TokenForge provisional configured-route pricing", "https://tokengate-cqt9ivzs.manus.space/pricing"),
...
export const PLAYGROUND_FEATURED_MODEL_IDS = ["claude-fable-5", "qwen3.8-max", "claude-opus-5", "kimi-k3", "qwen3.7-max"] as const;
