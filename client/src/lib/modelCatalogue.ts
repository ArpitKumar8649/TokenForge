...
export const TOKENFORGE_MODELS: CatalogueModel[] = [
  ...
  model("claude-fable-5", "Claude Fable 5", "Claude", "AI", "violet", 5, 25, "Advanced reasoning", "A capable text model for reasoning, coding, streamed chat, and inspectable Playground thinking summaries.", ["Reasoning", "Thinking", "Streaming", "Coding"], "TokenForge provisional configured-route pricing", "https://tokengate-cqt9ivzs.manus.space/pricing"),
