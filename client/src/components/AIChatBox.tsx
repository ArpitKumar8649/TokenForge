          ...
          <div className="flex h-full flex-col p-4">
            <div className="flex flex-1 flex-col items-center justify-center gap-6 text-muted-foreground">
              <div className="flex flex-col items-center gap-3">
                <TokenForgeGlyph className="size-12 opacity-30" label="TokenForge" />
          ...
          <ScrollArea className="h-full">
            <div className="flex flex-col space-y-4 p-4">
                  ...
                  >
                    {message.role === "assistant" && (
                      <div className="size-8 shrink-0 mt-1 rounded-full bg-primary/10 flex items-center justify-center">
                        <TokenForgeGlyph className="size-4 text-primary" label="TokenForge response" />
                      </div>
                    )}
              ...
              {isLoading && displayMessages[displayMessages.length - 1]?.role !== "assistant" && (
                ...
                >
                  <div className="size-8 shrink-0 mt-1 rounded-full bg-primary/10 flex items-center justify-center">
                    <TokenForgeGlyph className="size-4 text-primary" label="TokenForge is responding" />
                  </div>
